...
import { Center, Flex, FormControl, FormErrorMessage, FormLabel, Heading, Input } from "@chakra-ui/react";
...
export function FormInputAgendar({ handleInputChange, input, campo, id, type }: props) {
